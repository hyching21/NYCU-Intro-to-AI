...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        if len(actions) != 0:
          ...
          bestAction = random.choice(candidate)
    ...
    def getAction(self, state):
        ...
        "*** YOUR CODE HERE ***"
        # Begin your code
        if util.flipCoin(self.epsilon): #ϵ random
    ...
    def update(self, state, action, nextState, reward):
        ...
        old = (1 - self.alpha) * oldQValue
        self.QValues[(state,action)] = old + self.alpha * (reward + self.discount * self.computeValueFromQValues(nextState))
        # End your code
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for feature in featureVectors:
            totalValue += featureVectors[feature] * self.weights[feature]
        return totalValue
        # End your code
